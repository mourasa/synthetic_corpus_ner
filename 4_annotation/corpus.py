...
annotated_texts = open('../results/'+str(sys.argv[1])+'/annotated_texts.txt','r')

#Création du fichier de destination
output = open('../results/'+str(sys.argv[1])+'/corpus.txt','w')
...
output.close()
#Renvoie du fichier de destination

annotated = open('../results/'+str(sys.argv[1])+'/annotated_texts.txt','r')
print("Taille du corpus : " + str(len(annotated.readlines())))
annotated.close()
